...
//
// Each call goes through `withFreshConnection()` so a stale Salesforce
// session token auto-refreshes once on `INVALID_SESSION_ID` / `401`. See
// auth.ts:withFreshConnection.
